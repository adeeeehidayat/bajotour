...
<div class="container-otsb">
    <h1>Private Trip Sailing Boat</h1>
    <div class="price-booking">
        <span>Rp 500.000/orang</span>
        <a href="booking"><button type="button">Booking</button></a>
    </div>
    <div class="gallery">
        <div class="left-column">
            <img src="<?php echo base_url('images/otsb1.png'); ?>" alt="Gambar 1">
            <img src="<?php echo base_url('images/otsb2.png'); ?>" alt="Gambar 2">
            <img src="<?php echo base_url('images/otsb3.png'); ?>" alt="Gambar 3">
        </div>
        <div class="right-column">
            <img src="<?php echo base_url('images/otsb4.png'); ?>" alt="Gambar 4">
        </div>
    </div>
</div>
...
<div class="about-section">
    ...
    <div class="row">
        <div class="col-md-4">
            <div class="card">
                <div class="card-header">Pulau Kelor</div>
                <div class="card-body">
                    Rasakan keajaiban Pulau Kelor melalui perahu tamasya untuk menjelajahi hutan kecil yang menawarkan pemandangan pantai yang memukau.
                </div>
            </div>
        </div>
        <div class="col-md-4">
            <div class="card">
                <div class="card-header">Pulau Padar</div>
                <div class="card-body">
                    Trek ke puncak Pulau Padar untuk menikmati panorama keindahan tiga teluk berbeda, dan pesona kehidupan laut melalui aktivitas snorkeling di sekitar pulau.
                </div>
            </div>
        </div>
        <div class="col-md-4">
            <div class="card">
                <div class="card-header">Pulau Kanawa</div>
                <div class="card-body">
                    Temukan kehidupan bawah laut yang kaya dengan snorkeling, serta menikmati keindahan pantai pasir putih dan air jernih di Pulau Kanawa.
                </div>
            </div>
        </div>
    </div>
...
<div class="facilities-card">
    ...
    <div>
        <ul>
            ...
            <li>Sudah termasuk tiket masuk Taman Nasional Komodo</li>
            <li>Sudah termasuk tip tour guide / crew kapal</li>
        </ul>
    </div>
</div>
