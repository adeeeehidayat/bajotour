...
<audio id="backgroundAudio" autoplay loop>
    <source src="<?php echo base_url('sound/pulau.mp3'); ?>" type="audio/mpeg">
...
<div class="container-otsb">
    <h1 style="margin-bottom: 20px;">Pulau Kanawa</h1>
    <div class="gallery">
        <div class="left-column">
            <img src="<?php echo base_url('images/pulau_kanawa1.jpeg'); ?>" alt="Gambar 1">
            <img src="<?php echo base_url('images/pulau_kanawa2.jpeg'); ?>" alt="Gambar 2">
            <img src="<?php echo base_url('images/pulau_kanawa3.jpeg'); ?>" alt="Gambar 3">
        </div>
        <div class="right-column">
            <img src="<?php echo base_url('images/pulau_kanawa_utama.jpeg'); ?>" alt="Gambar 4">
        </div>
    </div>
</div>
...
<div class="about-section">
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                Pulau Kanawa, terletak di Nusa Tenggara Timur, adalah surga tersembunyi yang menakjubkan dengan pantai pasir putih, air laut yang jernih, dan kehidupan bawah laut yang beragam. Di sini, pengunjung dapat menikmati keindahan alam yang memukau dengan bersantai di tepi pantai yang sepi atau melakukan kegiatan snorkeling dan menyelam untuk menjelajahi keindahan terumbu karang yang masih alami. Pulau ini juga menawarkan akomodasi yang nyaman dalam suasana yang tenang dan alami, menjadikannya tempat ideal untuk melarikan diri dari keramaian dan menikmati ketenangan yang sempurna di tengah pesona alam yang belum terjamah.
                </div>
            </div>
        </div>
    </div>
