...
<div class="container-otsb">
    <h1 style="margin-bottom: 20px;">Pulau Koaba</h1>
    <div class="gallery">
        <div class="left-column">
            <img src="<?php echo base_url('images/pk1.png'); ?>" alt="Gambar 1">
            <img src="<?php echo base_url('images/pk2.png'); ?>" alt="Gambar 2">
            <img src="<?php echo base_url('images/pk3.png'); ?>" alt="Gambar 3">
        </div>
        <div class="right-column">
            <img src="<?php echo base_url('images/pk4.png'); ?>" alt="Gambar 4">
        </div>
    </div>
</div>
...
<div class="about-section">
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                Pulau Koaba, yang juga dikenal sebagai Pulau Kalong (Pulau Kelelawar Buah), adalah sebuah pulau melingkar dataran rendah berukuran lebar 500 meter dan tampak terdiri dari inti pepohonan tinggi yang dikelilingi oleh hutan bakau yang lebat. Saat senja, pemandangan ribuan kelelawar meninggalkan tempat bertenggernya dan menuju tempat mencari makannya merupakan pemandangan yang luar biasa.
                </div>
            </div>
        </div>
    </div>
