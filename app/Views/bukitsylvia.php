...
<audio id="backgroundAudio" autoplay loop>
    <source src="<?php echo base_url('sound/bukit.mp3'); ?>" type="audio/mpeg">
...
<div class="container-otsb">
    <h1 style="margin-bottom: 20px;">Bukit Sylvia</h1>
    <div class="gallery">
        <div class="left-column">
            <img src="<?php echo base_url('images/bukit_sylvia1.jpeg'); ?>" alt="Gambar 1">
            <img src="<?php echo base_url('images/bukit_sylvia2.jpeg'); ?>" alt="Gambar 2">
            <img src="<?php echo base_url('images/bukit_sylvia3.jpeg'); ?>" alt="Gambar 3">
        </div>
        <div class="right-column">
            <img src="<?php echo base_url('images/bukit_sylvia_utama.jpeg'); ?>" alt="Gambar 4">
        </div>
    </div>
</div>
...
<div class="about-section">
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                Bukit Sylvia, terletak di Nusa Tenggara Timur, adalah perwujudan keindahan alam yang menakjubkan. Dengan pemandangan yang menawan, bukit ini menawarkan panorama luar biasa dari ketinggian, memperlihatkan kombinasi megah antara lautan yang biru mempesona, lembah hijau subur, dan langit biru nan luas. Bukit Sylvia menjadi surga bagi para pecinta alam dan fotografer, mengundang untuk menjelajah dan menikmati ketenangan yang disuguhkan oleh keindahan alam yang tiada tara. Dengan udara yang segar dan gemuruh angin yang lembut, bukit ini memberikan pengalaman yang tak terlupakan bagi setiap pengunjungnya, mempersembahkan ketenangan dan keindahan yang hanya bisa ditemukan di sini.
                </div>
            </div>
        </div>
    </div>
