...
<div class="container-otsb">
    <h1>Private Trip Pantai Pink dan Pulau Komodo</h1>
    ...
    <div class="gallery">
        <div class="left-column">
            <img src="<?php echo base_url('images/otpppk1.png'); ?>" alt="Gambar 1">
            <img src="<?php echo base_url('images/otpppk2.png'); ?>" alt="Gambar 2">
        </div>
        <div class="right-column">
            <img src="<?php echo base_url('images/otpppk3.png'); ?>" alt="Gambar 4">
        </div>
    </div>
</div>
...
<div class="about-section">
    ...
    <div class="row">
        <div class="col-md-4">
            <div class="card">
                <div class="card-header">Pantai Pink</div>
                <div class="card-body">
                Selain menikmati keindahan pasirnya yang unik, pengunjung dapat berenang atau snorkeling di air laut yang jernih untuk melihat keindahan terumbu karang dan biota laut yang beragam.
                </div>
            </div>
        </div>
        <div class="col-md-4">
            <div class="card">
                <div class="card-header">Pulau Komodo</div>
                <div class="card-body">
                Aktivitas yang dapat dinikmati di Pulau Komodo meliputi trekking untuk melihat komodo di habitat alaminya, snorkeling di perairan yang jernih, dan menikmati pemandangan matahari terbenam yang memukau.
                </div>
            </div>
        </div>
    </div>
