...
<div class="container-otsb">
    <h1 style="margin-bottom: 20px;">Goa Batu Cermin</h1>
    <div class="gallery">
        <div class="left-column">
            <img src="<?php echo base_url('images/gbc1.png'); ?>" alt="Gambar 1">
            <img src="<?php echo base_url('images/gbc2.png'); ?>" alt="Gambar 2">
            <img src="<?php echo base_url('images/gbc3.png'); ?>" alt="Gambar 3">
        </div>
        <div class="right-column">
            <img src="<?php echo base_url('images/gbc4.png'); ?>" alt="Gambar 4">
        </div>
    </div>
</div>
...
<div class="about-section">
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                Gua ini dikenal karena efek cermin yang tercipta saat air laut mengisi gua pada saat air laut surut. Saat air surut, dinding gua yang terbuat dari batu kapur memantulkan cahaya matahari sehingga menciptakan efek cermin yang memukau di permukaan air. Pengunjung dapat menikmati pemandangan indah ini dengan memasuki gua dan melihat refleksi spektakuler dari dinding-dinding gua di air yang tenang.
                </div>
            </div>
        </div>
    </div>
