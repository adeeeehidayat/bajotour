...
<audio id="backgroundAudio" autoplay loop>
    <source src="<?php echo base_url('sound/pantai.mp3'); ?>" type="audio/mpeg">
...
<div class="container-otsb">
    <h1 style="margin-bottom: 20px;">Pantai Pink</h1>
    <div class="gallery">
        <div class="left-column">
            <img src="<?php echo base_url('images/pp1.png'); ?>" alt="Gambar 1">
            <img src="<?php echo base_url('images/pp2.png'); ?>" alt="Gambar 2">
            <img src="<?php echo base_url('images/pp3.png'); ?>" alt="Gambar 3">
        </div>
        <div class="right-column">
            <img src="<?php echo base_url('images/pp4.png'); ?>" alt="Gambar 4">
        </div>
    </div>
</div>
...
<div class="about-section">
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                Pantai Pink di Labuan Bajo adalah sebuah surga pantai yang menakjubkan di Pulau Komodo, Indonesia. Namanya diambil dari pasirnya yang berwarna merah muda yang langka dan indah. Pantai ini dikelilingi oleh air jernih berwarna biru turkis yang menampilkan keindahan alam bawah laut yang kaya akan kehidupan laut. Pemandangan di Pantai Pink sangat memukau dengan tebing-tebing batu karang dan vegetasi hijau yang menyegarkan di sekitarnya.
                </div>
            </div>
        </div>
    </div>
