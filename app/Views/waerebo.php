...
<audio id="backgroundAudio" autoplay loop>
    <source src="<?php echo base_url('sound/village.mp3'); ?>" type="audio/mpeg">
...
<div class="container-otsb">
    <h1 style="margin-bottom: 20px;">Wae Rebo Village</h1>
    <div class="gallery">
        <div class="left-column">
            <img src="<?php echo base_url('images/wae_rebo1.jpeg'); ?>" alt="Gambar 1">
            <img src="<?php echo base_url('images/wae_rebo2.jpeg'); ?>" alt="Gambar 2">
            <img src="<?php echo base_url('images/wae_rebo3.jpeg'); ?>" alt="Gambar 3">
        </div>
        <div class="right-column">
            <img src="<?php echo base_url('images/wae_rebo_utama.jpeg'); ?>" alt="Gambar 4">
        </div>
    </div>
</div>
...
<div class="about-section">
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                Wae Rebo Village, tersembunyi di ketinggian gunung di Nusa Tenggara Timur, adalah sebuah kampung adat yang memukau dengan pesona alam dan keaslian budaya. Terletak di atas awan, kampung ini menawarkan pemandangan luar biasa dari lembah yang hijau, dikelilingi oleh pegunungan yang menjulang tinggi. Rumah-rumah tradisional Mbaru Niang yang khas, beratap jerami dan berdinding alang-alang, menciptakan panorama yang memesona dari masa lalu yang masih hidup. Wae Rebo bukan hanya tempat bagi pengunjung untuk menikmati keindahan alam yang menakjubkan, tetapi juga sebuah perjumpaan dengan warisan budaya yang kaya dan masyarakat yang ramah, menjadikannya destinasi yang sangat istimewa bagi mereka yang mencari pengalaman wisata yang otentik dan mendalam.
                </div>
            </div>
        </div>
    </div>
