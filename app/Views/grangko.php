...
<audio id="backgroundAudio" autoplay loop>
    <source src="<?php echo base_url('sound/goa.mp3'); ?>" type="audio/mpeg">
...
<div class="container-otsb">
    <h1 style="margin-bottom: 20px;">Goa Rangko</h1>
    <div class="gallery">
        <div class="left-column">
            <img src="<?php echo base_url('images/gr1.png'); ?>" alt="Gambar 1">
            <img src="<?php echo base_url('images/gr2.png'); ?>" alt="Gambar 2">
            <img src="<?php echo base_url('images/gr3.png'); ?>" alt="Gambar 3">
        </div>
        <div class="right-column">
            <img src="<?php echo base_url('images/gr4.png'); ?>" alt="Gambar 4">
        </div>
    </div>
</div>
...
<div class="about-section">
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                Terletak di Pulau Flores, gua ini terkenal karena airnya yang berwarna biru turkis yang jernih dan kolam alami di dalamnya. Para pengunjung dapat menikmati petualangan menyusuri gua yang gelap dengan memasuki gua tersebut melalui jalur air yang dangkal. Di dalam gua, cahaya matahari masuk melalui lubang-lubang kecil di langit-langit gua, menciptakan efek cahaya yang dramatis di atas air biru.
                </div>
            </div>
        </div>
    </div>
