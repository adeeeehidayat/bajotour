...
<div class="container-otsb">
    <h1 style="margin-bottom: 20px;">Pulau Padar</h1>
    <div class="gallery">
        <div class="left-column">
            <img src="<?php echo base_url('images/ppadar1.png'); ?>" alt="Gambar 1">
            <img src="<?php echo base_url('images/ppadar2.png'); ?>" alt="Gambar 2">
            <img src="<?php echo base_url('images/ppadar3.png'); ?>" alt="Gambar 3">
        </div>
        <div class="right-column">
            <img src="<?php echo base_url('images/ppadar4.png'); ?>" alt="Gambar 4">
        </div>
    </div>
</div>
...
<div class="about-section">
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                Pulau Padar di Labuan Bajo adalah sebuah pulau yang menakjubkan dengan pemandangan alam yang memukau. Terletak di Taman Nasional Komodo, pulau ini terkenal karena panorama indahnya yang meliputi bukit-bukit berbatu yang curam, pasir putih, dan air laut berwarna biru jernih. Pendakian menuju puncak Pulau Padar menawarkan pemandangan spektakuler dari atas dengan panorama tiga teluk berbeda yang memiliki air laut berwarna-warni dan pantai-pantai cantik
                </div>
            </div>
        </div>
    </div>
