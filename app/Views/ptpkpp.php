...
<div class="container-otsb">
    <h1>Private Trip Pulau Komodo dan Pulau Padar</h1>
    ...
    <div class="gallery">
        <div class="left-column">
            <img src="<?php echo base_url('images/ptpkpp1.png'); ?>" alt="Gambar 1">
            <img src="<?php echo base_url('images/ptpkpp2.png'); ?>" alt="Gambar 2">
        </div>
        <div class="right-column">
            <img src="<?php echo base_url('images/ptpkpp3.png'); ?>" alt="Gambar 4">
        </div>
    </div>
</div>
